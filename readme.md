...
- `./scripts/mrl-refine` starts Codex in the repo root with `gpt-5.4` and `medium` reasoning effort.
- `./scripts/mrl-build` starts Codex in the repo root with `gpt-5.3-codex` and `medium` reasoning effort.
