...
<head>
    ...
    <title>The Origin Blueprint — HireFlow</title>
...
<div class="max-w-3xl mx-auto px-4 py-6">
    <header class="mb-6">
        ...
        <h1 class="mt-3 text-xl tracking-tight text-zinc-300">[Arc] The Origin Blueprint — HireFlow</h1>
    </header>
    ...
    <h2 class="arc-name">The Origin Blueprint</h2>
    <p class="text-sm text-zinc-400 mb-4">The opening arc of the HireFlow saga. We define the purpose of the system, the architectural drivers, the functional outcomes, and the first structural boundaries.</p>
    <section>
        <h2 class="text-sm text-zinc-400 mb-2">EPISODES</h2>
            ...
            <ul class="space-y-1">
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— 2025-11-14</span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— 2025-11-24</span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— 2025-12-05</span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— 2025-12-28</span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— 2025-12-29</span>
                    </li>
...
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>The First Breath — Game Hub</title>
    <link rel="icon" href="/favicon.ico">
    <link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png">
    <link rel="apple-touch-icon" href="/apple-touch-icon.png">
...
<div class="max-w-3xl mx-auto px-4 py-6">
    <header class="mb-6">
        ...
        <h1 class="mt-3 text-xl tracking-tight text-zinc-300">[Arc] The First Breath — Game Hub</h1>
    </header>
    ...
    <h2 class="arc-name">The First Breath</h2>
    <p class="text-sm text-zinc-400 mb-4">Where the Game Hub comes to life — setting the tone, philosophy, and first challenge: a Trivia Duel to validate the platform.</p>
    <section>
        <h2 class="text-sm text-zinc-400 mb-2">EPISODES</h2>
            ...
            <ul class="space-y-1">
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— 2025-12-03</span>
                    </li>
