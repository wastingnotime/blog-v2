...
<div class="max-w-3xl mx-auto px-4 py-6">
    <header class="mb-6">
        ...
        <h1 class="mt-3 text-xl tracking-tight text-zinc-300">[Saga] HireFlow</h1>
    </header>
    ...
    <p class="text-sm text-zinc-400 mb-4">A fictional hiring platform built as a real-world laboratory for exploring microservices architecture, trade-offs, and emergent design.</p>
        ...
        <section class="mb-5">
            ...
            <div>
                <a class="hover:underline" href="/sagas/hireflow/the-origin-blueprint/">[Arc] The Origin Blueprint</a>
                
                    <span class="text-zinc-500 text-xs">— latest:
        
            <a class="hover:underline" href="/sagas/hireflow/the-origin-blueprint/identifying-our-first-services/">Ep 03</a>
        
            , <a class="hover:underline" href="/sagas/hireflow/the-origin-blueprint/interactions-flows-and-early-event-design/">Ep 04</a>
        
            , <a class="hover:underline" href="/sagas/hireflow/the-origin-blueprint/architecture-diagram-and-narrative/">Ep 05</a>
    ...
    <section>
        ...
        <ul class="space-y-1">
                ...
                <li>
                    <a class="hover:underline" href="/sagas/hireflow/the-origin-blueprint/">[Arc] The Origin Blueprint</a>
                    <span class="text-zinc-500 text-xs">— 5 eps; last 2025-12-29</span>
                </li>
        ...
        <section class="mt-6">
            ...
            <ul class="space-y-1">
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— The Origin Blueprint / 2025-12-29</span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— The Origin Blueprint / 2025-12-28</span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— The Origin Blueprint / 2025-12-05</span>
                    </li>
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— The Origin Blueprint / 2025-11-24</span>
                    </li>
                
                    <li>
                        <a class="hover:underline" href="/sagas/hireflow/the-origin-blueprint/the-first-brick/">[Ep 01] The First Brick</a>
                        <span class="text-zinc-500 text-xs">— The Origin Blueprint / 2025-11-14</span>
                    </li>
...
<div class="max-w-3xl mx-auto px-4 py-6">
    <header class="mb-6">
        ...
        <h1 class="mt-3 text-xl tracking-tight text-zinc-300">[Saga] Game Hub</h1>
    </header>
    ...
    <p class="text-sm text-zinc-400 mb-4">Building a modular hub where multiple games can live, share logic, and evolve in the cloud — from the first API call to distributed systems patterns.</p>
        ...
        <section class="mb-5">
            <h2 class="text-sm text-zinc-400 mb-1">CURRENT ARC</h2>
            <div>
                <a class="hover:underline" href="/sagas/game-hub/the-first-breath/">[Arc] The First Breath</a>
                
                    <span class="text-zinc-500 text-xs">— latest:
        
            <a class="hover:underline" href="/sagas/game-hub/the-first-breath/how-a-duel-is-born/">Ep 03</a>
        
            , <a class="hover:underline" href="/sagas/game-hub/the-first-breath/designing-the-first-api/">Ep 04</a>
        
            , <a class="hover:underline" href="/sagas/game-hub/the-first-breath/building-the-matchmaker/">Ep 05</a>
    ...
    <section>
        ...
        <ul class="space-y-1">
                ...
                <li>
                    <a class="hover:underline" href="/sagas/game-hub/the-first-breath/">[Arc] The First Breath</a>
                    <span class="text-zinc-500 text-xs">— 5 eps; last 2025-12-03</span>
                </li>
        ...
        <section class="mt-6">
            ...
            <ul class="space-y-1">
                    ...
                    <li>
                        ...
                        <span class="text-zinc-500 text-xs">— The First Breath / 2025-12-03</span>
                    </li>
